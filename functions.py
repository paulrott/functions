...
# print_greeting()
#
# # receive the descriptoin of the function
# help(print_greeting)
...
#
#
# retutned_value = greeting_depends_on_gender('Jack','male')
# retutned_value = greeting_depends_on_gender('Jane','female')
# retutned_value = greeting_depends_on_gender('Ja','cmale')
...
retutned_value_1 = greeting_depends_on_gender('Jack','male')
retutned_value_2 = greeting_depends_on_gender('Jane','female')
retutned_value_3 = greeting_depends_on_gender('Ja','cmale')

print(retutned_value_1)
print(retutned_value_2)
print(retutned_value_3)
